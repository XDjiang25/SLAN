...
def visual(true, preds=None, name='./pic/test.pdf'):
    ...
    """
    plt.figure()
    #dates = pd.date_range(start='2020-09-01', end='2023-12-31', freq='M')
...
def vali(args, accelerator, model, vali_data, vali_loader, criterion, mae_metric, mape_metric):
    
    # folder_path = './visresults/' 
    ...
    # np.save(folder_path + 'true.npy', preds)
...
def test_res(args, accelerator, model, vali_data, vali_loader, criterion, mae_metric, mape_metric):
    
    folder_path = './visresults/DLinear' 
    if not os.path.exists(folder_path):
        os.makedirs(folder_path)    
