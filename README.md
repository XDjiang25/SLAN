...
If you want to customize the training, you can modify the parameters in [`scripts/SLAN_ETTh1.sh`](/scripts/SLAN_ETTh1.sh) to adjust batch size, learning rate, mask rates, or other hyperparameters.
